...
SELECT
    rooms.RoomCode,
    rooms.RoomName,
    SUM(DATEDIFF(LEAST(reservations.CheckOut, '2011-01-01'), GREATEST(reservations.CheckIn, '2010-01-01'))) AS DaysOccupied
FROM
    rooms
JOIN
    reservations ON reservations.Room = rooms.RoomCode
WHERE
    reservations.CheckIn < '2011-01-01' AND reservations.CheckOut > '2010-01-01'
GROUP BY
    rooms.RoomCode,
    rooms.RoomName
ORDER BY
